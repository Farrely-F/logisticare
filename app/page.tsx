  ...
  const features = [
    {
      ...
      description:
        "Soal otomatis menggunakan Google Gemini untuk topik logistik rumah sakit",
      color: "bg-blue-500",
    },
    {
      icon: FileText,
      ...
      description:
        "Materi pembelajaran komprehensif yang dihasilkan AI sesuai topik dan tingkat kesulitan",
      color: "bg-green-500",
    },
    {
      icon: Target,
      ...
      description:
        "Penjelasan jawaban, petunjuk, dan umpan balik dari AI Agent",
      color: "bg-purple-500",
    },
    {
      icon: Trophy,
      ...
      description:
        "Kuis dapat dijeda dan dilanjutkan kapan saja dengan auto-save otomatis",
      color: "bg-yellow-500",
    },
  ];
        ...
        <div className="container mx-auto px-3 sm:px-4 py-3 sm:py-4">
          <div className="flex items-center justify-between">
            ...
            <div className="hidden md:flex items-center space-x-4">
              ...
              <Link href="/quiz">
                <Button className="bg-gradient-to-r from-blue-600 to-green-600 hover:from-blue-700 hover:to-green-700 text-sm px-4 py-2">
                  Mulai Kuis
                </Button>
              </Link>
            </div>
                ...
                <SheetContent side="right" className="w-[300px] sm:w-[400px]">
                  <SheetHeader>
                    <SheetTitle className="flex items-center space-x-2">
                      ...
                      <span>LogistiCare Prep</span>
                    </SheetTitle>
                    <SheetDescription>
                      Platform pembelajaran AI untuk persiapan ujian logistik
                      rumah sakit
                    </SheetDescription>
                  </SheetHeader>
                  ...
                  <div className="flex flex-col space-y-4 mt-8">
                    <Link href="/quiz" className="w-full">
                      <Button className="w-full bg-gradient-to-r from-blue-600 to-green-600 hover:from-blue-700 hover:to-green-700 text-sm py-3">
                        <Zap className="w-4 h-4 mr-2" />
                        Mulai Kuis
                      </Button>
                    </Link>

                    <div className="mt-4 divide-y flex flex-col gap-2 border-y">
                      <Link href="/reading-materials" className="w-full">
                        <Button
                          variant="ghost"
                      ...
                      <Link href="/data-management" className="w-full">
                        <Button
                          variant="ghost"
                          className="w-full justify-start text-sm py-3"
                        >
        ...
        <div className="container mx-auto text-center">
          <div className="max-w-4xl mx-auto">
            ...
            <p className="text-base sm:text-xl text-gray-600 mb-8 max-w-2xl mx-auto px-4 sm:px-0">
              Platform pembelajaran interaktif yang menggunakan kecerdasan
              buatan untuk membantu Anda menguasai ujian lingkup kerja logistik
              rumah sakit dengan cara yang menyenangkan dan efektif.
            </p>
            <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center items-center px-4 sm:px-0">
              ...
              <Link href="/reading-materials" className="w-full sm:w-auto">
                <Button
                  size="lg"
                  variant="outline"
                  className="text-sm sm:text-lg px-6 sm:px-8 py-3 bg-transparent w-full sm:w-auto"
                >
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 sm:gap-8">
            ...
            <div className="text-center">
              <div className="text-2xl sm:text-3xl font-bold text-green-600 mb-1 sm:mb-2">
                {stats.questionsGenerated.toLocaleString()}
              </div>
              <div className="text-xs sm:text-base text-gray-600">
                Soal Dihasilkan
              </div>
        ...
        <div className="container mx-auto">
          <div className="text-center mb-12 sm:mb-16">
            ...
            <p className="text-base sm:text-xl text-gray-600 max-w-2xl mx-auto px-4 sm:px-0">
              Teknologi AI terdepan untuk pengalaman belajar yang personal dan
              efektif
            </p>
          </div>
        ...
        <div className="container mx-auto">
          <div className="text-center mb-12 sm:mb-16">
            ...
            <p className="text-base sm:text-xl text-gray-600 px-4 sm:px-0">
              Materi lengkap sesuai kurikulum ujian logistik rumah sakit
            </p>
          </div>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
            {topics.map(
              (
                topic: { name: string; questions: number; icon: any },
                index: number
              ) => (
                <Card
                  key={index}
      ...
      <section className="py-16 sm:py-20 px-4 bg-gradient-to-r from-blue-600 to-green-600">
        <div className="container mx-auto text-center">
          <div className="max-w-3xl mx-auto text-white">
            <h2 className="text-2xl sm:text-4xl font-bold mb-4 sm:mb-6 px-4 sm:px-0">
            ...
            <p className="text-base sm:text-xl mb-6 sm:mb-8 opacity-90 px-4 sm:px-0">
              ...
              berhasil lulus ujian dengan bantuan platform AI kami.
            </p>
            <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center px-4 sm:px-0">
              <Link href="/dashboard" className="w-full sm:w-auto">
                <Button
                  size="lg"
                  variant="secondary"
                  className="text-sm sm:text-lg px-6 sm:px-8 py-2 sm:py-3 w-full sm:w-auto"
                >
          ...
          <div className="grid md:grid-cols-4 gap-8">
            <div>
              ...
              <p className="text-gray-400">
                Platform pembelajaran AI untuk persiapan ujian logistik rumah
                sakit.
              </p>
            </div>
            <div>
