...
import { Trophy, BookOpen, Brain, Zap, Calendar, Home, Users } from "lucide-react"
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-600">Lanjutkan perjalanan belajar Anda untuk menguasai ujian logistik rumah sakit.</p>
        </div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
          ...
          <Card>
            <CardContent className="p-4 text-center">
              <div className="text-2xl font-bold text-yellow-600 mb-1">{userStats.timeSpent}h</div>
              <div className="text-sm text-gray-600">Waktu Belajar</div>
            </CardContent>
          </Card>
          <Card>
            <CardContent className="p-4 text-center">
              <div className="text-2xl font-bold text-purple-600 mb-1">#{userStats.rank}</div>
        ...
        <Tabs defaultValue="overview" className="space-y-6">
          <TabsList className="grid w-full grid-cols-4">
            ...
            <TabsTrigger value="badges">Lencana</TabsTrigger>
                ...
                <CardContent>
                  <div className="space-y-4">
                    <div className="flex justify-between items-center">
                      ...
                      <Badge variant="outline">{userStats.xp} XP</Badge>
                    </div>
